...
\ifpdf
  \makeatletter
  \usepackage[plainpages=false,hypertexnames=false,bookmarksnumbered,pdfpagelabels,%
...
% \begin{singlespace} %% No more single-spaciness for these
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \titlespacing*{\chapter}{0pt}{-50p}{\baselineskip}
...
\addtocontents{toc}{\protect\setlength{\protect\cftbeforechapskip}{0.5\baselineskip}}
